...
# to 177 cases plus the tper-prep (128) and trid-prep (256) check sets, and every case kprints a line
...
chk "edge-abi: 177 of 177 cases correct" \
    "every one of the 177 ABI cases returned the reason the ABI specifies" \
    "not 177/177 - read the named FAIL line(s) above; each names its case, want and got"
