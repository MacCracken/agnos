...
#
# Usage:   scripts/smoke/basestack-run-smoke.sh <agnos-elf> <expect-substring> [name]
#   e.g.   scripts/smoke/basestack-run-smoke.sh ../hoosh/build/hoosh_agnos 2.4.11 hoosh
