...
# staged by scripts/smoke/aethersafha-smoke.sh (build/ae-smoke/agnos-ae.img, the
...
if not os.path.exists(IMG):
    print("FAIL: %s missing — run scripts/smoke/aethersafha-smoke.sh first" % IMG); sys.exit(1)
