...
#
# ⚠ SCOPE, STATED HONESTLY: this runs texlist, bigate, bimodel, texgate, rtaudit, depthgate, perspbits, perspdiv,
...
rc=0
for t in texlist bigate bimodel texgate rtaudit depthgate depthmodel depthdiv perspbits perspdiv; do
