...
# gpu-test/edgeasm.cyr emitter — so that a bug in either is caught by the other. This script closes
...
#
# Usage:
#   scripts/shader-blob.sh emit  kernel/shaders/tri_rgba.s tri_rgba   # print the Cyrius writer
#   scripts/shader-blob.sh check kernel/shaders/tri_rgba.s tri_rgba   # diff vs the committed table
#   scripts/shader-blob.sh rsrc  kernel/shaders/tri_rgba.s tri_rgba   # print harvested RSRC1/RSRC2
set -u
