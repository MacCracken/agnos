...
- **Remaining this cycle**: B2 retransmit + RTO/backoff, B3 MSS option + send segmentation, B4 honor peer SND.WND. Congestion control + RTT-estimated RTO deferred (audit § 7).
