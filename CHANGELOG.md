...
- **Build/test** — production build 798,936 → **805,680 B**. `test.sh` 4/4 + `check.sh` 11/11 after bumping their binary-size sanity ceilings (`test.sh` 800 K and `check.sh`'s stale 350 K — red since the 1.31.x storage arc — both → 1.2 M).
