// tex_list_cm.s — RUNG 14b: op 0x0C GPU_OP_TEX_LIST with the LANE AXIS TRANSPOSED.
//
...
tex_list_cm:
    ...
    s_lshr_b32      s6, s17, 16             // ph   ⚠ TRANSPOSED vs tex_list.s: s6 is the PER-LANE
...
L_HAVE_TEXEL:
    ...
    // ======================================================================================
    v_mov_b32       v14, s9                 // px  (wave-uniform under COLMAJOR)
