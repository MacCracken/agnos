...
> **9b = 11 bites, 8 at zero burns.** `edge_cov` is a **two-dispatch** gfx90c rasteriser: a per-edge prologue kernel computes `(ylo, yhi, M, d, V, L)` into an 8 KB arena table using a 32-iteration exact integer reciprocal, then a **64×1, one-lane-per-pixel** raster kernel walks the edge table per sub-scanline with a **sort-free breakpoint walk**, computing each crossing with **25 branch-free 32-bit VALU** via `q̂ = (P·V)>>63` plus **one** correction — exact, trunc-toward-zero, proved algebraically and verified over 600,000 whole-expression cases at `±2^30` with **zero mismatches and corrections never above 1**. **No LDS, no DS instruction, no sort, no cross-lane operation, no `RSRC2` change, no dispatcher change, no `v_rcp` of any width, no new encoding format.** ~100 + ~55 instructions across two blobs in arena slots 6 and 7. Preconditions landed as their own bites: the `refraster.cyr` extraction with the `accrow` fatal fixed, the itemised 20-case corpus, the `±2^28` coordinate guard (required for the *reference* to be well-defined at all), and an authoring tool calibrated by re-emitting `blend_cov`'s 67 shipped dwords. **Deviations recorded: 64×1 not 8×8; NONZERO only; `n_edges ≤ 64` for the first landing.**"
  ...
  "workflowProgress": [
    ...
    },
    {
      "type": "workflow_agent",
      "index": 1,
      "label": "survey:encoder",
      "phaseIndex": 1,
      "phaseTitle": "Survey",
      "agentId": "a5b6ba869e0d6a25b",
      "model": "claude-opus-5",
      "state": "done",
      "startedAt": 1785010996185,
      "queuedAt": 1785010996169,
      "attempt": 1,
      "lastToolName": "StructuredOutput",
      "lastToolSummary": "Audit of mabda/src/gfx9_encode.cyr as an authoring tool for…",
...
THE TASK CONTEXT — 3D arc "rung 9b": write a gfx90c (AMD Vega/GCN5 class APU, gfx9 ISA) compute
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785011518427,
      "tokens": 125530,
      "toolCalls": 29,
      "durationMs": 522242,
      "resultPreview": "{"area":"Audit of mabda/src/gfx9_encode.cyr as an authoring tool for the rung-9b gfx90c coverage-rasteriser shader","findings":[{"claim":"The file is 411 lines: 118 module-scope `var` opcode/operand constants and exactly 19 functions. All 19 are pure bit-packing (single `return <masked ORs>` expressions) — no allocation, no syscalls, no validation, no error returns. It is an ENCODER, not an assemb…"
    },
    {
      "type": "workflow_agent",
      "index": 2,
      ...
      "phaseIndex": 1,
      "phaseTitle": "Survey",
      "agentId": "a6a04a7b7e28a6f60",
      "model": "claude-opus-5",
      "state": "done",
      "startedAt": 1785010996186,
      "queuedAt": 1785010996169,
      "attempt": 1,
      "lastToolName": "StructuredOutput",
      "lastToolSummary": "Exact operational semantics of cpuref.cyr fn raster() + fn …",
      "promptPreview": "You are working on AGNOS, a sovereign OS written in Cyrius (a systems language, NOT C/Rust).
Repo: /home/macro/Repos/agnos. Sibling repo with a gfx9 instruction ENCODER: /home/macro/Repos/mabda.
...
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785012003617,
      "tokens": 148000,
      "toolCalls": 42,
      "durationMs": 1007430,
      "resultPreview": "{"area":"Exact operational semantics of cpuref.cyr fn raster() + fn span_add() (rung 8 reference), specified for a bit-identical gfx90c GPU port (3D arc rung 9b)","findings":[{"claim":"EVERY value in the reference is i64. Cyrius has one integer type; edges, crossings and the accumulator are all load64/store64. The only narrow value in the whole algorithm is the final coverage byte via store8. Ther…"
    },
    {
      "type": "workflow_agent",
      "index": 3,
      ...
      "attempt": 1,
      "lastToolName": "StructuredOutput",
      "lastToolSummary": "3D arc rung 9b — the dispatch envelope a new gfx90c integer…",
      "promptPreview": "You are working on AGNOS, a sovereign OS written in Cyrius (a systems language, NOT C/Rust).
Repo: /home/macro/Repos/agnos. Sibling repo with a gfx9 instruction ENCODER: /home/macro/Repos/mabda.
...
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785011429604,
      "tokens": 137001,
      "toolCalls": 41,
      "durationMs": 433418,
      "resultPreview": "{"area":"3D arc rung 9b — the dispatch envelope a new gfx90c integer edge-rasteriser shader must fit into (agnos kernel/core/gpu.cyr + gpu_regs.cyr)","findings":[{"claim":"Q1 RESIDENCY — the *_arm() pattern is a 5-gate idempotent lazy upload followed by a blob write and an mfence. Canonical peer (blend_cov): `fn gpu_cov_arm() { if (gpu_cov_armed == 1) { return 1; } if (gpu_present == 0) { return 0…"
    },
    {
      "type": "workflow_agent",
      "index": 4,
      "label": "survey:priorart",
      "phaseIndex": 1,
      "phaseTitle": "Survey",
      "agentId": "a49f69cc91e914c8e",
      "model": "claude-opus-5",
      "state": "done",
      "startedAt": 1785010996187,
      "queuedAt": 1785010996169,
      "attempt": 1,
      "lastToolName": "StructuredOutput",
      "lastToolSummary": "Prior art for rung 9b: (A) signed integer division on gfx9/…",
      "promptPreview": "You are working on AGNOS, a sovereign OS written in Cyrius (a systems language, NOT C/Rust).
Repo: /home/macro/Repos/agnos. Sibling repo with a gfx9 instruction ENCODER: /home/macro/Repos/mabda.
...
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785012045399,
      "tokens": 153581,
      "toolCalls": 57,
      "durationMs": 1049212,
      "resultPreview": "{"area":"Prior art for rung 9b: (A) signed integer division on gfx9/GCN, (B) GPU coverage/analytic-AA rasterisers — with a bit-exactness analysis of the cpuref.cyr algorithm and four candidate division strategies, three of which I verified numerically.","findings":[{"claim":"THE EXACT LLVM AMDGPU 32-bit sdiv/udiv EXPANSION. Verbatim from the current source: uitofp Y -> f32; llvm.amdgcn.rcp (lowere…"
    },
    {
      "type": "workflow_agent",
      "index": 5,
...
the CPU re…",
    ...
    },
    {
      "type": "workflow_agent",
      "index": 6,
      "label": "design:faithful",
      "phaseIndex": 2,
      "phaseTitle": "Design",
      "agentId": "a24bc0c0dc0c6e3e5",
      "model": "claude-opus-5",
      "state": "done",
      "startedAt": 1785012045418,
      "queuedAt": 1785012045403,
      "attempt": 1,
      "lastToolName": "StructuredOutput",
      "lastToolSummary": "FAITHFUL PORT — wave-uniform crossing solve + LDS bitonic s…",
      "promptPreview": "You are working on AGNOS, a sovereign OS written in Cyrius (a systems language, NOT C/Rust).
Repo: /home/macro/Repos/agnos. Sibling repo with a gfx9 instruction ENCODER: /home/macro/Repos/mabda.
...
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785013063341,
      "tokens": 205992,
      "toolCalls": 17,
      "durationMs": 1017923,
      "resultPreview": "{"name":"FAITHFUL PORT — wave-uniform crossing solve + LDS bitonic sort + per-lane span walk, on an exact 30-iteration restoring 64/32 divider","summary":"Commit: reproduce cpuref.cyr's `raster()` operation-for-operation on gfx90c, with the ONE structural change that the hardware forces and nothing else.\
\
The mapping is **64×1×1, one lane per pixel of a 64-pixel row strip** — NOT the 8×8 tile in…"
    },
    {
      "type": "workflow_agent",
      "index": 7,
      "label": "design:divfree",
      "phaseIndex": 2,
      "phaseTitle": "Design",
      "agentId": "ace614a895b720dde",
      "model": "claude-opus-5",
      "state": "done",
      "startedAt": 1785012045419,
      "queuedAt": 1785012045403,
      "attempt": 1,
      "lastToolName": "StructuredOutput",
      "lastToolSummary": "MULINV-EDGE — hoist one exact reciprocal per edge; every cr…",
      "promptPreview": "You are working on AGNOS, a sovereign OS written in Cyrius (a systems language, NOT C/Rust).
Repo: /home/macro/Repos/agnos. Sibling repo with a gfx9 instruction ENCODER: /home/macro/Repos/mabda.
...
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785012991794,
      "tokens": 172186,
      "toolCalls": 12,
      "durationMs": 946374,
      "resultPreview": "{"name":"MULINV-EDGE — hoist one exact reciprocal per edge; every crossing becomes 25 branch-free 32-bit VALU ops","summary":"The divisor `by - ay` is constant per edge, so the division belongs in an EDGE PROLOGUE, not in the crossing loop. Two structural moves make the per-crossing path division-free and provably bit-identical:\
\
(1) SIGN COLLAPSE. `trunc(N·t/D)` = `sign(N) · floor(M·u/d)` where…"
    },
    {
      "type": "workflow_agent",
      "index": 8,
      ...
      "phaseIndex": 2,
      "phaseTitle": "Design",
      "agentId": "a749b52c99dea83c6",
      "model": "claude-opus-5",
      "state": "done",
      "startedAt": 1785012045420,
      "queuedAt": 1785012045403,
      "attempt": 1,
      "lastToolName": "StructuredOutput",
      "lastToolSummary": "span_cov — the staged split-dial rasteriser: CPU keeps the …",
      "promptPreview": "You are working on AGNOS, a sovereign OS written in Cyrius (a systems language, NOT C/Rust).
Repo: /home/macro/Repos/agnos. Sibling repo with a gfx9 instruction ENCODER: /home/macro/Repos/mabda.
...
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785012791604,
      "tokens": 171896,
      "toolCalls": 16,
      "durationMs": 746184,
      "resultPreview": "{"name":"span_cov — the staged split-dial rasteriser: CPU keeps the divide, GPU takes the area","summary":"**Commit: split rung 9b at the span boundary.** The CPU (kernel-side, inside `gpu_edge_cov`) does scan conversion — half-open y test, the signed 64/32 divide, the sort, the winding walk — and emits a per-row list of CLAMPED covered spans `(lo, hi)` in 16.16 into a GPU-visible arena buffer. Th…"
    },
    {
      "type": "workflow_agent",
      "index": 9,
      "label": "judge:bitexact",
      "phaseIndex": 3,
      "phaseTitle": "Judge",
      "agentId": "a86a8861e12ce28d1",
      "model": "claude-opus-5",
      "state": "done",
      "startedAt": 1785013063363,
      "queuedAt": 1785013063347,
      "attempt": 1,
      "lastToolName": "StructuredOutput",
      "lastToolSummary": "BIT-EXACTNESS — can I find a concrete legal input where the…",
      "promptPreview": "You are working on AGNOS, a sovereign OS written in Cyrius (a systems language, NOT C/Rust).
Repo: /home/macro/Repos/agnos. Sibling repo with a gfx9 instruction ENCODER: /home/macro/Repos/mabda.
...
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785013639964,
      "tokens": 207524,
      "toolCalls": 9,
      "durationMs": 576600,
      "resultPreview": "{"lens":"BIT-EXACTNESS — can I find a concrete legal input where the approach's mask differs from cpuref.cyr's raster() by ≥1 byte?","rankings":[{"approach":"span_cov (staged split-dial: CPU keeps the divide, GPU takes the area)","score":9,"why":"I attacked this hardest and could not move it. The crossing math is not ported at all — it stays as the literal Cyrius i64 expression from cpuref.cyr:157…"
    },
    {
      "type": "workflow_agent",
      "index": 10,
      "label": "judge:feasible",
      "phaseIndex": 3,
      "phaseTitle": "Judge",
      "agentId": "a36a9834e1493727c",
      "model": "claude-opus-5",
      "state": "done",
      "startedAt": 1785013063364,
      "queuedAt": 1785013063348,
      "attempt": 1,
      "lastToolName": "StructuredOutput",
      "lastToolSummary": "FEASIBILITY ON THIS TOOLCHAIN — can the blob actually be au…",
      "promptPreview": "You are working on AGNOS, a sovereign OS written in Cyrius (a systems language, NOT C/Rust).
Repo: /home/macro/Repos/agnos. Sibling repo with a gfx9 instruction ENCODER: /home/macro/Repos/mabda.
...
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785013312806,
      "tokens": 183588,
      "toolCalls": 8,
      "durationMs": 249441,
      "resultPreview": "{"lens":"FEASIBILITY ON THIS TOOLCHAIN — can the blob actually be authored and maintained in agnos today, given that (a) agnos ships shaders as literal store32 dword tables with no assembler, (b) mabda's gfx9_encode.cyr is 19 pure field-packing functions with no tokeniser, no label/patch pass and no DS/SOPK format, and (c) every branch offset in every shipped shader is a hand-counted hex constant.…"
    },
    {
      "type": "workflow_agent",
      "index": 11,
      ...
      "phaseIndex": 3,
      "phaseTitle": "Judge",
      "agentId": "ad4e9a06988055ef9",
      "model": "claude-opus-5",
      "state": "done",
      "startedAt": 1785013063364,
      "queuedAt": 1785013063349,
      "attempt": 1,
      "lastToolName": "StructuredOutput",
      "lastToolSummary": "ARC VALUE + DEBUGGABILITY — (a) does it actually move the e…",
      "promptPreview": "You are working on AGNOS, a sovereign OS written in Cyrius (a systems language, NOT C/Rust).
Repo: /home/macro/Repos/agnos. Sibling repo with a gfx9 instruction ENCODER: /home/macro/Repos/mabda.
...
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785013378853,
      "tokens": 205765,
      "toolCalls": 7,
      "durationMs": 315489,
      "resultPreview": "{"lens":"ARC VALUE + DEBUGGABILITY — (a) does it actually move the expensive work to the GPU, judged against rung 10's kill gate (gpu.md:817, pre-registered at ~50k covered px/frame ≈ 80 glyphs, measured on the SAME burn as rung 9 at zero extra flash); and (b) when it paints a wrong triangle on iron, can the failure be attributed from gputri's four outcomes (all-sentinel / wrong shape / wrong edge…"
    },
    {
      "type": "workflow_agent",
      "index": 12,
      ...
      "agentId": "a1cd48879dd89bf0c",
      "model": "claude-opus-5",
      "state": "done",
      "startedAt": 1785013639966,
      "queuedAt": 1785013639965,
      "attempt": 1,
      "lastToolName": "Bash",
      "lastToolSummary": "cd /tmp/claude-1000/-home-macro-Repos-agnosticos/abc8d5e9-5…",
      "promptPreview": "You are working on AGNOS, a sovereign OS written in Cyrius (a systems language, NOT C/Rust).
Repo: /home/macro/Repos/agnos. Sibling repo with a gfx9 instruction ENCODER: /home/macro/Repos/mabda.
...
shader that rasterises an edge array into an 8bpp coverage mask, and it must be BYTE-IDENTICAL to
the CPU re…",
      "lastProgressAt": 1785014314642,
      "tokens": 217487,
      "toolCalls": 6,
      "durationMs": 674676,
      "resultPreview": "# RUNG 9b — IMPLEMENTATION PLAN
