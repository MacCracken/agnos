...
| Field | Value | Source |
|---|---|---|
| Kernel head | **1.56.37 — OPEN** (opened 2026-08-03, the initial scanout) | [`VERSION`](../../VERSION) |
| Previous cut | **1.56.36 RELEASED 2026-08-03** — native-resolution scanout + hardware-panned console. Iron-confirmed across four burns | [`CHANGELOG.md`](../../CHANGELOG.md) |
