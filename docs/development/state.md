...
> **Last refresh**: 2026-07-28 · kernel head **1.56.25** (open) · **▶ ACTIVE — 1.56.x GPU (the one open GPU release; there is no 1.57/1.58/1.59).** Full plan + reference:
...
| Field | Value | Source |
|---|---|---|
| **Kernel** | **1.56.25** | [`VERSION`](../../VERSION) |
