...
> **Last refresh**: 2026-06-07 · kernel **1.42.12** (build **1,096,464 B**, x86_64 multiboot2 OK) · cyrius pin **6.0.56**.
>
...
| Field | Value | Source |
|---|---|---|
| **Kernel** | **1.43.1** | [`VERSION`](../../VERSION) |
| **Cyrius toolchain pin** | **6.0.56** | `cyrius.cyml [package].cyrius` |
| **Released** | 2026-06-07 | [`CHANGELOG.md`](../../CHANGELOG.md) |
